...
Current stable release: **[v0.7.0](https://github.com/xilele777/snotes/releases/tag/v0.7.0)** ([all releases](https://github.com/xilele777/snotes/releases)). Standalone server support starts with `v0.7.0`.
